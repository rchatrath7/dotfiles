...
[ -f ~/.gitz/gitz.zsh ] && source ~/.gitz/gitz.zsh

if [ -z $SPIN ]; then
    [ -f /opt/dev/dev.sh ] && source /opt/dev/dev.sh

    if [ -e /Users/rchatrath/.nix-profile/etc/profile.d/nix.sh ]; then . /Users/rchatrath/.nix-profile/etc/profile.d/nix.sh; fi # added by Nix installer
